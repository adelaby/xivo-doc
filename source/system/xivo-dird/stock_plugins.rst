...
* uuid: the XIVO_UUID of the remote XiVO
* service_id: the web service login on the remote XiVO
* service_key: the secret key of the web service
* datacenter(optional): the name of the consul datacenter on which the other XiVO is running
